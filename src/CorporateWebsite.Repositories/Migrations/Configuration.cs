...
namespace CorporateWebsite.Repositories.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CorporateWebsite.Repositories.EntityFramework.CaiXiaoDbContext>
    {
        ...
        protected override void Seed(CorporateWebsite.Repositories.EntityFramework.CaiXiaoDbContext context)
        {
            #region 模块管理
            List<Module> modules = new List<Module>
            {
                ...
                new Module { Id = 2, ParentId = 1, Name = "角色管理", LinkUrl = "~/BackGround/Role/Index",  Code = 201,Description = null, IsMenu = true, Enabled = true, UpdateDate = DateTime.Now},
                new Module { Id = 3, ParentId = 1, Name = "用户管理", LinkUrl = "~/BackGround/User/Index", Code = 202, Description = null, IsMenu = true, Enabled = true, UpdateDate = DateTime.Now },
                new Module { Id = 4, ParentId = 1, Name = "模块管理", LinkUrl = "~/BackGround/Module/Index",  Code = 204, Description = null, IsMenu = true, Enabled = true,  UpdateDate = DateTime.Now },
                new Module { Id = 5, ParentId = 1, Name = "权限管理", LinkUrl = "~/BackGround/Permission/Index",  Code = 205, Description = null, IsMenu = true, Enabled = true,  UpdateDate = DateTime.Now },
                ...
                new Module { Id = 8, ParentId = 1, Name = "用户组管理", LinkUrl = "~/BackGround/UserGroup/Index",  Code = 203, Description = null, IsMenu = true, Enabled = true,  UpdateDate = DateTime.Now }
